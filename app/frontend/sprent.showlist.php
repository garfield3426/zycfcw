...
class ShowList extends Page{
    ...
    function getSqlWhere(){
        $sqlWhere = " where ftype=2 and fytype=246  and i.state=1 ";
			...
			switch ($this->filter['zj']){
				case 1:
				 $sqlWhere .= " and i.zj<=2000";
				  break;
				case 2:
				  $sqlWhere .= " and i.zj >=2000 and i.zj <= 4000";
				  break;
				case 3:
				  $sqlWhere .= " and i.zj >=4000 and i.zj <= 6000";
				  break;
				 case 4:
				 ...
				 case 5:
				  ...
				  break;
				 case 6:
				  $sqlWhere .= " and i.zj >=10000 and i.zj <= 15000";
				  break;
				 case 7:
				  $sqlWhere .= " and i.zj >=15000";
				  break;
				default:
				  echo "";
			}
