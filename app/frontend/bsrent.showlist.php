...
class ShowList extends Page{
    ...
    function getData(){
        ...
        while(!$rs->EOF){
			...
			$rs->fields['num'] = sizeof($rs->fields['sn_images']);
    ...
    function filter(){
        ...
        if(is_numeric($this->input['czfs']))          $filter['czfs'] = $this->input['czfs'];//特色
    ...
    function getSqlWhere(){
        $sqlWhere = " where ftype=2 and fytype=244 and i.state = 1 ";
		...
		$sqlWhere .= isset($this->filter['czfs'])  ? " and i.czfs = '{$this->filter['czfs']}'" : '';//特色
		//处理总价
		if(isset($this->filter['zj'])){
			switch ($this->filter['zj']){
				case 1:
				 $sqlWhere .= " and i.zj<=2000";
				  break;
				case 2:
				  $sqlWhere .= " and i.zj >=2000 and i.zj <= 3000";
				  break;
				case 3:
				  $sqlWhere .= " and i.zj >=3000 and i.zj <= 4000";
				  break;
				 case 4:
				  $sqlWhere .= " and i.zj >=4000 and i.zj <= 5000";
				  break;
				 case 5:
				  $sqlWhere .= " and i.zj >=5000 and i.zj <= 6000";
				  break;
				 case 6:
				  $sqlWhere .= " and i.zj >=6000 and i.zj <= 8000";
				  break;
				 case 7:
				  $sqlWhere .= " and i.zj >=8000 and i.zj <= 10000";
				  break;
				 case 8:
				  $sqlWhere .= " and i.zj >=10000";
				  break;
				default:
				  echo "";
			}
		...
		if(isset($this->filter['mj'])){
			switch ($this->filter['mj']){
				case 1:
				 $sqlWhere .= " and i.jzmj<=50";
				  break;
				case 2:
				  $sqlWhere .= " and i.jzmj >=50 and i.jzmj <= 70";
				  break;
				case 3:
				  $sqlWhere .= " and i.jzmj >=70 and i.jzmj <= 90";
				  break;
				 case 4:
				  $sqlWhere .= " and i.jzmj >=90 and i.jzmj <= 110";
				  break;
				 case 5:
				  $sqlWhere .= " and i.jzmj >=110 and i.jzmj <= 130";
				  break;
				 case 6:
				  $sqlWhere .= " and i.jzmj >=130 and i.jzmj <= 150";
				  break;
				 case 7:
				  $sqlWhere .= " and i.jzmj >=150 and i.jzmj <= 200";
				  break;
				case 8:
				  $sqlWhere .= " and i.jzmj >=200 and i.jzmj <= 300";
				  break;
				 case 9:
				  $sqlWhere .= " and i.jzmj >=300";
				  break;
				default:
				  echo "";
			}
    ...
    function getJsonData(){
        return array(
            ...
            'row' => array(
			 ...
			 //'item[qy]' => Category::getSelList( $item['qy'], $this->conf->get('quyuCateId'), false, '',false,$this->lang->get('j_global_cateSelDisableMsg')),//区域
            ...
            'item[czfs]' => Category::getSelList( $item['czfs'], $this->conf->get('chuzufangshiCateId'), false, '',false,$this->lang->get('j_global_cateSelDisableMsg')),//出租方式
