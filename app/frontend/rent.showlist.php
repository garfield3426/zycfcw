...
class ShowList extends Page{
    ...
    function getSqlWhere(){
        $sqlWhere = " where ftype=2 and fytype=243  and i.state = 1 ";
		...
		if(isset($this->filter['zj'])){
			switch ($this->filter['zj']){
				case 1:
				 $sqlWhere .= " and i.zj<=1000";
				  break;
				case 2:
				  $sqlWhere .= " and i.zj >=1000 and i.zj <= 1500";
				  break;
				case 3:
				  $sqlWhere .= " and i.zj >=1500 and i.zj <= 2000";
				  break;
				 case 4:
				 ...
				 case 6:
				  ...
				  break;
				 case 7:
				  $sqlWhere .= " and i.zj >=5000 and i.zj <= 8000";
				  break;
				 case 8:
				  $sqlWhere .= " and i.zj >=8000";
				  break;
				default:
				  echo "";
			}
