...
class Report extends Page{
    ...
    function getData(){
        $sql = "select id,title,name,sex,age,types,tel,qq,email,address,content,put_time,reply,reply_time from {$this->tab} where state<>2 order by id desc";
	...
	public function report(){	
		...
		$key=array('id','留言标题','留言人姓名','性别','年龄','就诊类型','电话','qq','email','地址','病情说明','留言时间','回复内容','回复时间');
