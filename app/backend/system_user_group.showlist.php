...
class ShowList extends Page{
    ...
    function process(){
        $pvar = array(
            ...
            //页面标题
            'title' => $this->lang->get('p_systemUserGroup_showlistTitle'),
        );
        //设定模板使用变量
    ...
    function getJsonData(){
        return array(
            ...
            'kw_state' => array(
                ...
                'list' => array(
                    '' => '',
                    '0' => $this->lang->get('p_systemUserGroup_stateDisabled'),
                    '1' => $this->lang->get('p_systemUserGroup_stateEnabled'),
                    //'2' => $this->lang->get('p_systemUserGroup_stateDelete'),
                ),
            ),
            //多选操作
            'mulop' => array(
                ...
                'list' => array(
                    '' => '',
                    'Enable' => $this->lang->get('p_systemUserGroup_mulopEnable'),
                    'Disable' => $this->lang->get('p_systemUserGroup_mulopDisable'),
                    'disabled_1' => '------',
                    'Delete' => $this->lang->get('p_systemUserGroup_mulopDelete'),
                ),
                'action' => array(
                    'type' => 'mulopChoose',
                    'Enable' => array(
                        'msg' => $this->lang->get('j_systemUserGroup_mulopEnable'),
                        'url' => Core::getUrl('state', '', array('value'=>1)),
                    ),
                    'Disable' => array(
                        'msg' => $this->lang->get('j_systemUserGroup_mulopDisable'),
                        'url' => Core::getUrl('state', '', array('value'=>0)),
                    ),
                    'Delete' => array(
                        'msg' => $this->lang->get('j_systemUserGroup_mulopDelete'),
            ...
            'deleteLink' => array(
                'msg' => $this->lang->get('j_systemUserGroup_deleteItemMsg'), 
                'url' => Core::getUrl('state', '', array('value'=>2)),
            ),
        );
    }
