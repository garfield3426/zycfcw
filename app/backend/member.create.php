...
class Create extends Page{
    ...
    function validate($i){
        ...
        if(!strlen($i['phone'])){
            $e['phone'] = $this->lang->get('e_member_phoneIsEmpty');
        }
        if(!strlen($i['intro'])){
            $e['intro'] = $this->lang->get('e_member_introIsEmpty');
        }
        if(!strlen($i['area'])){
            $e['area'] = $this->lang->get('e_member_areaIsEmpty');
        }
        if(!strlen($i['userpass'])){
            $e['userpass'] = $this->lang->get('e_member_userpassIsEmpty');
        }
        if(!strlen($i['cuserpass'])){
            $e['cuserpass'] = $this->lang->get('e_member_cuserpassIsEmpty');
        }
