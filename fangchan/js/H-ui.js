...
/*返回顶部*/
var $backToTopEle=$('<a href="javascript:void(0)" class="toTop" title="返回顶部" alt="返回顶部"></a>').appendTo($("body")).click(function(){
...
$(function(){
	...
	$("table thead th input:checkbox").on("click" , function(){
		$(this).closest("table").find("tr > td:first-child input:checkbox").not("[disabled]").attr("checked", this.checked).closest("tr").toggleClass("selected", this.checked);
    });
